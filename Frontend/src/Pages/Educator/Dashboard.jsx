...
import { assets, dummyDashboardData } from '../../assets/assets/assets.js';
...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:px-8 md:pb-0 p-4 pt-8 pb-0'>
      <div classsName='space-y-5'>
